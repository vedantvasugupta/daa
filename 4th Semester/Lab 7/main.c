// code for binary tree in c insertion & deletion
...
int main()
{
    ...
    printf("Inserted all the elements in the B-Tree\n");
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Deleted 7 from B-Tree\n");
    deletion(7, root);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Deleted 20 from B-Tree\n");
    deletion(20, root);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Inserted 15 into B-Tree\n");
    insertion(15);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Inserted 23 into B-Tree\n");
    insertion(23);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Deleted 21 from B-Tree\n");
    deletion(21, root);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Deleted 31 from B-Tree\n");
    deletion(31, root);
    traversal(root);
    printf("\n");
    printf("\n");
    printf("Deleted 23 from B-Tree\n");
    deletion(23, root);
    traversal(root);
    printf("\n");
}